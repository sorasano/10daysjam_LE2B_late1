...
void PaperCircle::OnCollision(float windPower, Vector3 fanTrans) {
	move_ = 1;
...
void PaperCircle::CalculationSpeed()
{
	//速度を計算
...
void PaperCircle::Set(float windPower, Vector3 fanTrans)
{
	//速度,落下スピード,減速をセット
	...
	decelerationRate_ = 0.01;
}

void PaperCircle::LandingJudge()
{
